...
<body background="images/Background.png">
    ...
    <nav class="navbar navbar-dark bg-dark border-bottom-0 p-0 mt-0">
        <div class="container-fluid justify-content-between">
            ...
            <section class="mt-2 mb-2 d-inline-block justify-content-end">
                <a class="btn btn-outline-light btn-floating m-0" href="#!" role="button"><i
    ...
    <marquee behavior="alternate" direction="right">-- Latest Products --</marquee>
    <center>
        <H2 style="font-family: Raleway, sans-serif; margin: 0px;"><em>-- Latest Products --</em></H2>
    </center>
    <marquee behavior="alternate" direction="left">-- Latest Products --</marquee>
